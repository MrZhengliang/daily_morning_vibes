...
# 禁用代理设置 (如果你在本地跑遇到网络问题，可以把这些注释掉；但在服务器通常保留比较好)
...
def generate_simple_image(text_en, filename):
    ...
    # 最后一个参数 100 是透明度 (0全透 - 255全黑)，可根据喜好调整
...
def main():
    print(f"[{datetime.now()}] 启动内容生成 (本地存储模式)...")
